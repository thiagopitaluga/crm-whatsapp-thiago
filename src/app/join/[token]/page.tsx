...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça um novo convite.',
  },
  used: {
  ...
  server_error: {
    ...
    body: 'Não foi possível verificar o convite agora. Atualize a página em alguns instantes.',
  },
};
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              Ao aceitar, seu acesso será transferido para{' '}
              <span className="text-muted-foreground">{peek.account_name}</span>. A conta pessoal vazia criada no cadastro será removida.
            </p>
          </CardContent>
        </Card>
        ...
        >
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                Para entrar em{' '}
                <span className="text-popover-foreground">{peek.account_name}</span>, saia e cadastre-se novamente com outro endereço de e-mail. O convite continuará válido enquanto não expirar.
              </p>
            </div>
