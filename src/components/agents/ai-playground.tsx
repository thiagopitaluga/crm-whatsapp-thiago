        ...
        {turns.length === 0 && (
          <div className="flex h-full flex-col items-center justify-center text-center text-sm text-muted-foreground">
            ...
            <p className="mt-1 text-xs">
              Ele usa sua base de conhecimento e se comporta como o robô de resposta automática, incluindo o encaminhamento para um humano.
            </p>
            {onGoToSetup && (
              <Button
                variant="link"
              ...
              >
                Ainda não configurou? Acesse Configuração <ArrowRight className="ml-1 h-3 w-3" />
              </Button>
            )}
          </div>
        )}
            ...
            >
              ...
              {t.role === 'assistant' && t.handoff && (
                ...
                >
                  ...
                  Encaminharia para um atendente aqui
                </p>
              )}
            </div>
            {t.role === 'user' && (
